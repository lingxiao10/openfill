...
export class RemotePageController {
	...
	async inputTextAndEnter(...args: any[]): Promise<DomActionReturn> {
		return this.remoteCallDomAction('input_text_and_enter', args)
	}
	...
	async clickBlankArea(...args: any[]): Promise<DomActionReturn> {
		const res = await this.remoteCallDomAction('click_blank_area', args)
